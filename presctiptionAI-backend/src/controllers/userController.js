...
const updateUserDetails = async (req, res, next) => {
    const {gender, height, weight, chest, hips, date_of_birth, waist } = req.body;
    const userId = req.user?.userId;
    return userService.updateUserDetails(userId, gender, height, weight, chest, hips, date_of_birth, waist)
